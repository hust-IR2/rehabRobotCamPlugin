...
class CTChart0 : public COleDispatchDriver
{
public:
	CTChart0(){} // 调用 COleDispatchDriver 默认构造函数
	CTChart0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CTChart0(const CTChart0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
